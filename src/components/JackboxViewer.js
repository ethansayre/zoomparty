...
class JackboxViewer extends React.Component {
  render() {
    return (
      <IframeResizer
        log
        src={"https://jackbox.tv"} sandbox={"allow-forms allow-scripts allow-same-origin"} allow={"microphone; camera; fullscreen"}
